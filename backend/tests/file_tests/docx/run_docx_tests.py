...
def main():
    ...
    # 테스트 실행
    results = []
    for test_file in DOCX_TEST_FILES:
    ...
    print(f"\n{'='*60}")
    if all_passed:
        print("모든 DOCX 테스트가 성공했습니다!")
        sys.exit(0)
    else:
        print("일부 DOCX 테스트가 실패했습니다.")
        sys.exit(1)
