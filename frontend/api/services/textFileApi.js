...
export const getTextfilesByBrain = (brainId) => 
    api.get(`/textfiles/brain/${brainId}`)
        .then(r => r.data)
        .catch(error => {
            console.error(`브레인 텍스트 파일 목록 조회 실패 (브레인 ID: ${brainId}):`, error);
            throw error;
        });
