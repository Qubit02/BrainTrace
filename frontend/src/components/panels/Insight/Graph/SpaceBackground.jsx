...
const SpaceBackground = ({ isVisible = false, isDarkMode = true }) => {
    ...
    const lightModeStyles = {
        ...
        starBackground: `
            ...
            radial-gradient(1.5px 1.5px at 320px 260px, #f43f5e, transparent),
            radial-gradient(1px 1px at 420px 140px, #a855f7, transparent),
            radial-gradient(1.5px 1.5px at 520px 360px, #22c55e, transparent),
            radial-gradient(1px 1px at 620px 200px, #eab308, transparent),
            radial-gradient(1.5px 1.5px at 720px 340px, #0ea5e9, transparent),
            radial-gradient(1px 1px at 820px 120px, #f97316, transparent),
            radial-gradient(1.5px 1.5px at 920px 240px, #8b5cf6, transparent),
            radial-gradient(1px 1px at 1020px 180px, #06b6d4, transparent),
            radial-gradient(1px 1px at 150px 150px, #3b82f6, transparent),
            radial-gradient(1.5px 1.5px at 250px 250px, #60a5fa, transparent),
            radial-gradient(1px 1px at 350px 350px, #8b5cf6, transparent),
            radial-gradient(1.5px 1.5px at 450px 450px, #10b981, transparent),
            radial-gradient(1px 1px at 550px 550px, #f59e0b, transparent),
            radial-gradient(1.5px 1.5px at 650px 650px, #ef4444, transparent),
            radial-gradient(1px 1px at 750px 750px, #06b6d4, transparent),
            radial-gradient(1.5px 1.5px at 850px 850px, #ec4899, transparent),
            radial-gradient(1px 1px at 950px 950px, #84cc16, transparent),
            radial-gradient(1.5px 1.5px at 1050px 1050px, #f97316, transparent),
            radial-gradient(1px 1px at 200px 300px, #6366f1, transparent),
            radial-gradient(1.5px 1.5px at 300px 400px, #14b8a6, transparent),
            radial-gradient(1px 1px at 400px 500px, #f43f5e, transparent),
            radial-gradient(1.5px 1.5px at 500px 600px, #a855f7, transparent),
            radial-gradient(1px 1px at 600px 700px, #22c55e, transparent),
            radial-gradient(1.5px 1.5px at 700px 800px, #eab308, transparent),
            radial-gradient(1px 1px at 800px 900px, #0ea5e9, transparent),
            radial-gradient(1.5px 1.5px at 900px 1000px, #f97316, transparent),
            radial-gradient(1px 1px at 1000px 1100px, #8b5cf6, transparent),
            radial-gradient(1.5px 1.5px at 1100px 1200px, #06b6d4, transparent)
        `
    };
    ...
    return (
        ...
        <div
            ...
            style={{
                ...
                background: currentStyles.background,  // 선택된 모드의 배경 그라데이션
                zIndex: -1,               // 다른 요소들 뒤에 배치
                pointerEvents: 'none'     // 마우스 이벤트 무시 (배경 클릭 방지)
            }}
        >
            {/* === 별들 애니메이션 레이어 === */}
            {/* 움직이는 별들을 표현하는 별도 레이어 */}
            <div style={{
                ...
                width: '100%',            // 부모 전체 너비
                height: '100%',           // 부모 전체 높이
                backgroundImage: currentStyles.starBackground,  // 별들 패턴
                backgroundRepeat: 'repeat',                    // 패턴 반복
                backgroundSize: '1100px 400px',               // 별들 패턴 크기
                opacity: isDarkMode ? 0.9 : 0.85,             // 모드별 투명도
                animation: 'simpleStarMove 60s linear infinite' // 60초 주기로 무한 반복 애니메이션
            }} />
        </div>
    );
};
